               ...
               <tbody>
                   ...
                   <tr v-else v-for="(c,i) in cart" :key="i">
                       ...
                       <td>
                           ...
                           <button class="btn small btn-warning mx-1" @click="handleSubstractProduct(c.product._id)">-</button>
                           <button class="btn small btn-danger mx-1" @click="handleRemoveProduct(c.product._id)">remove</button>
                       </td>
